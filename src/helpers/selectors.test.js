...
const state = {
  ...
  appointments: {
    ...
    "7": {
      id: 7,
      time: "3pm",
      interview: { student: "Mark Knophler", interviewer: 1 }
    },
    "8": {
      id: 8,
      time: "4pm",
      interview: { student: "Justin Trudo", interviewer: 2 }
    }
  },
  interviewers: {
    "1": {  
...
test("InterviewersForDay returns an array containing the correct interviewer objects", () => {
